...
gui::menubar::create_navigation() noexcept
{
...

    {
        ...
        item = Gio::MenuItem::create("Next Image", "app.page_next");
        item->set_attribute_value("accel", Glib::Variant<Glib::ustring>::create("Down"));
        section->append_item(item);

        item = Gio::MenuItem::create("Previous Image", "app.page_prev");
...

    {
        ...
        item = Gio::MenuItem::create("First Image", "app.page_first");
        item->set_attribute_value("accel", Glib::Variant<Glib::ustring>::create("Home"));
        section->append_item(item);

        item = Gio::MenuItem::create("Last Image", "app.page_last");
