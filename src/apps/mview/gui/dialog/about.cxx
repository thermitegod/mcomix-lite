...
gui::dialog::about::about(Gtk::ApplicationWindow& parent) noexcept
{
    ...
    set_comments("MView is an image viewer that utilizes the MComix backend");
    ...
    const std::vector<Glib::ustring> authors{
        "",
        "MComix-lite (MComix3 Fork)",
        "Developer:   Brandon Zorn (thermitegod) <43489010+thermitegod@users.noreply.github.com>",
        "   C++, Gtk 4, lots of bugs",
        "",
        "MComix3 (Sourceforge Fork)",
        "Developer: multiSnow",
        "Developer: WJ Liu",
        "Developer: pirate486743186",
        "Developer: chelovechishko",
        "Developer: MOLY Jean-Marc",
        "",
        "MComix (Sourceforge)",
        "Developer: Louis Casillas",
        "Developer: Moritz Brunner",
        "Developer: Ark",
        "Developer: Benoit Pierre",
        "",
        "Comix (Original)",
        "Developer: Pontus Ekberg",
        "   Original vision/developer of Comix",
        "",
        "Includes Code From:",
