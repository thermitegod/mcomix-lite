...
supported_archive_extensions() noexcept
{
...
std::array<std::string_view, 27>
supported_image_extensions() noexcept
{
...
bool
is_archive(const std::filesystem::path& filename) noexcept
{
    static const auto extensions = supported_archive_extensions();
...
bool
is_image(const std::filesystem::path& filename) noexcept
{
    static const auto extensions = supported_image_extensions();
