...
from mcomix import callback, mt
...
class Pageselector(Gtk.Dialog):
    ...
    def __init__(self, window):
        ...
        self.__image_preview.set_size_request(prefs['thumbnail size'], prefs['thumbnail size'])
    ...
    def _generate_thumbnail(self, page, width, height):
        ...
        return page, self.__window.imagehandler.get_thumbnail(
