...
class KeybindingEditorWindow(Gtk.ScrolledWindow):
    ...
    def _on_accel_edited(self, renderer, path: str, accel_key: int, accel_mods, hardware_keycode: int):
    ...
    def _get_on_accel_edited(self, column: int):
        return self._on_accel_edited

    def _on_accel_cleared(self, renderer, path: str, *args):
        _iter = self.__treestore.get_iter(path)
        col = column + 3
